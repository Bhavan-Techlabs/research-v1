...
class MongoDBManager:
    ...
    """
    def __init__(self, collection_name, mongodb_uri=None, database_name="research_assistant"):
        self.mongodb_uri = mongodb_uri or os.getenv("MONGODB_URI")
        if not self.mongodb_uri:
            raise ValueError("MongoDB URI not provided. Set MONGODB_URI environment variable or pass it as parameter.")
